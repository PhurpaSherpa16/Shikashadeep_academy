        ...
        <div className='container py-16 lg:pb-24 px-4'>
            <div className='space-y-8'>
                <div className='space-y-4 grid place-items-center'>
                    ...
                    <div>
                        <h1 className='text-center lg:text-start'>What Our Students Say?</h1>
                        <p className='w-full md:w-2xl text-center lg:text-start'>We are proud of our students and their achievements. Here are some of their experiences and thoughts about learning at Shikshadeep Academy, where education meets encouragement and growth.</p>
                    </div>
                </div>
