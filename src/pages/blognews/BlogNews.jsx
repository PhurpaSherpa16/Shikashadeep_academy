                ...
                <div className="flex flex-wrap gap-3 items-center justify-center lg:justify-start">
                    {allTags.map((tag) => (
                        <button
                            ...
                            className={`px-4 py-1.5 rounded-full text-sm transition-all duration-300 border ${activeTag.toLowerCase() === tag.toLowerCase()
                                    ? "bg-(--blueDark) text-white border-(--blueDark) shadow-lg shadow-blue-900/20 scale-105"
                                    : "bg-white text-gray-600 border-gray-200 hover:border-(--blueDark) hover:text-(--blueDark) hover:shadow-md"
                                }`}
                        >
                            {tag}
                        </button>
                ...
                {totalPages > 1 && (
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-12">
                        ...
                        <div className="flex items-center gap-3">
                            <Button
                                variant="outline"
                                className="rounded-full px-6 py-5 h-auto font-bold border-2 hover:bg-gray-50 transition-all disabled:opacity-30"
