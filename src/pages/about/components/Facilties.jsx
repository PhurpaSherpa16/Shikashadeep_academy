  ...
  return (
    <div className='space-y-12 py-8'>
      ...
      <div className='space-y-4 max-w-4xl mx-auto text-center'>
        <h1 className='font-serif text-3xl md:text-4xl'>{facilities_data.label}</h1>
      ...
      {/* Slideshow */}
      <div className='relative w-full md:max-w-xl lg:max-w-6xl mx-auto bg-gray-50 rounded-2xl overflow-hidden shadow-xl flex flex-col'>
        <div className='grid grid-cols-1 lg:grid-cols-2 h-full'>
          {/* Text Section */}
          <div className='p-8 lg:p-16 flex flex-col justify-center bg-white order-2 lg:order-1 h-full
          space-y-4'>
          ...
          {/* Image Section */}
          <div className='relative h-full order-1 lg:order-2 overflow-hidden bg-gray-200'>
            <img
              key={current}
              src={facilities_data.items[current].image}
              alt={facilities_data.items[current].title}
              className='h-60 lg:h-110 w-full object-cover object-center animate-in fade-in zoom-in-105 duration-700'
            />
